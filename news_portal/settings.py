...
SECRET_KEY = 'django-insecure-x3nwo%wtsf194)vu#7252&qe*l1^m&_f@$kdsjg9cbt42ib1_u'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['127.0.0.1', '192.168.50.220', 'orangepilite', 'straz.asuscomm.com', ]
...
# путь перехода после успешной регистрации пользователя
LOGIN_REDIRECT_URL = '/'
